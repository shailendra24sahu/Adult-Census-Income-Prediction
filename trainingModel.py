...
class trainModel:
    ...
    def trainingModel(self):
        ...
        try:
            ...
            data=preprocessor.encode_label_column(data,label_column_name='salary')
            # balancing the dataset 
            data=preprocessor.handle_imbalanced_dataset(data,label_column_name='salary')
            ...
            X = preprocessor.scaling_the_data(X)
